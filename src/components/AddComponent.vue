...
<v-card>
    ...
    <v-card-text>
        ...
        <v-text-field label="Nombre del Curso" v-model="nombre"></v-text-field>
        <v-text-field label="Costo" v-model="costo" type="number"></v-text-field>
        <v-text-field label="Duración" v-model="duracion"></v-text-field>
        <v-text-field label="Cupos" v-model="cupos" type="number"></v-text-field>
        <v-text-field label="Inscritos" v-model="inscritos" type="number"></v-text-field>
        <v-text-field label="Fecha de Registro" v-model="fecha_registro"></v-text-field>
        <v-text-field label="URL de la Imagen" v-model="img"></v-text-field> <!-- Nuevo campo para la imagen -->
...
<style scoped>
/* Estilos para el componente AddComponent */
</style>
